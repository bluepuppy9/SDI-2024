            ...
            //send message to chatbox
             const data = await fetch('http://localhost:5000/chat', {
                ...
                body: JSON.stringify({
                    ...
                    message: 'respond to this message(response is sent to user)response should be 5 sentence max unless asked otherwise also act like a personal assistant:' +message[0] + ' | UserMessageLog: ' + chatlogUser.value
                })
                })
