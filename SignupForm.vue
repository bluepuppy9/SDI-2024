<template>
    <div>
        <form @submit.prevent="handleSubmit">
            ...
            <div v-for="skill in skills" :key="skill" class="pill" @click.left="deleteSkill(skill)">
                {{ skill }}
            </div>
    ...
    methods: {
        addSkill(e) {
            if (e.key === ',' && this.tempSkill) {
                if (!this.skills.includes(this.tempSkill) && (this.tempSkill !== ',')) {
